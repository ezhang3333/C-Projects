#include "sudoku.h"
//mp7 was worked on by Akhil Morisetty(akhilm6), Ethan Zhang(ethanjz2), Aashay Soni(asoni29)

//-------------------------------------------------------------------------------------------------
// Start here to work on your MP7
//-------------------------------------------------------------------------------------------------
/* The machine problem uses different functions and recursive backtracking to fill out 
the contents of a soduku board . The first four functions defined check whether a certain
numbers works in a given row,colunm, or 3x3 zone. In the fourth function is_val_valid a
certain number is checked if it can be placed in a certain index by calling the previous 3 functions.
Moreover, using recursive backtracking in the solve_sudoku function the is_val_valid function is called
to check against every possible index at the empty indexes. Finally, a private function all_assigned is called 
to check whether all of the indexes in the sudoku are already assigned or not
